...
<html lang="en">
  ...
  <body>
    ...
    <br>
    <form action="actionInsertA.php" method="post">
    <div class="input-group flex-nowrap" style="margin-left: 30px;">
         ...
         <input type="text" class="form-control" name="author" placeholder="input author" aria-label="Username" aria-describedby="addon-wrapping">
    </div> <br>
